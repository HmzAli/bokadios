    ...
    <section className="order" id="find-us">
      <div className="container">
        ...
        <p className="text-center location-text">
          We're located in Damansara Perdana—drop us a visit if you're nearby and craving a quick bite. You can also find us on <a target="_blank" href="https://www.foodpanda.my/ms/restaurant/u6qm/bokadios-damansara-perdana">FoodPanda</a> for convenient delivery straight to your door.
        </p>
