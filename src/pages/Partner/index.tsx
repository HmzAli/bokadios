...
function Partner() {
  return (
    <Layout>
      <PageMetadata
        title="Partner - BOKADIOS"
        description="Interested in retailing or serving Bokadios? Partner with us for wholesale supply, cafe collaborations, or event catering in Kuala Lumpur and Selangor."
        canonical="https://bokadios.com/partner"
      />
        ...
        <div className="container">
          ...
          <div className="partner-content text-center">
            <p className="lead mb-4">
              Looking to serve Bokadios at your café, office, or event?<br />
